    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex justify-between items-center">
            ...
            <div class="text-right">
                <div class="text-sm text-gray-600">ID: {{ $conversationLog->id }}</div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-8 mb-8">
            ...
            <div class="border-b border-gray-200 pb-6 mb-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <div>
                            @if($conversationLog->direction === 'incoming')
            ...
            <div class="mb-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    <p class="text-gray-900 whitespace-pre-wrap">{{ $conversationLog->message_content }}</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg">
                <div>
                    ...
                    <p class="text-sm text-gray-900">{{ $conversationLog->message_type }}</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-900">{{ $conversationLog->botInstance?->name ?? '—' }}</p>
                </div>
                <div>
                    <h4 class="text-xs font-semibold text-gray-600 uppercase mb-1">Message ID</h4>
                    <p class="text-sm text-gray-900 font-mono text-xs">{{ $conversationLog->message_id }}</p>
                </div>
            </div>

            <!-- Metadata (if exists) -->
            @if(!empty($conversationLog->metadata))
                <div class="mt-6">
