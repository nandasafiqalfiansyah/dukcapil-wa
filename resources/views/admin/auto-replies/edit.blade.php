                    ...
                    <form action="{{ route('admin.auto-replies.update', $autoReply) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="response" id="response" rows="6" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('response', $autoReply->response) }}</textarea>
                            @error('response')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
