        ...
        <div class="flex flex-col flex-grow bg-white border-r border-gray-200 pt-5 pb-4 overflow-y-auto shadow-lg lg:shadow-none">
            ...
            <div class="mt-5 flex-grow flex flex-col">
                <nav class="flex-1 px-2 space-y-1">
                    ...
                    <!-- Message Test -->
                    <a href="{{ route('admin.message-test.index') }}" 
                           class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.message-test.*') ? 'bg-whatsapp-100 text-whatsapp-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg class="mr-3 flex-shrink-0 h-6 w-6 {{ request()->routeIs('admin.message-test.*') ? 'text-whatsapp-600' : 'text-gray-400 group-hover:text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Bot Management Section -->
                        ...
                        <button @click="openSection = openSection === 'bots' ? '' : 'bots'" 
                            ...
                            <div x-show="openSection === 'bots'" class="space-y-1 ml-8">
                                ...
                                <a href="{{ route('admin.bots.index') }}" 
                                   class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.bots.show') ? 'text-whatsapp-600' : 'text-gray-600 hover:text-gray-900' }}">
                                    Bot Status
                                </a>
                            </div>
                    </div>
