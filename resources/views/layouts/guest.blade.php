...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 relative overflow-hidden gradient-whatsapp">
            ...
            <div class="relative z-10 scale-in-animation">
                <a href="/" class="block text-center mb-8">
                    <div class="inline-flex items-center justify-center w-20 h-20 bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 pulse-glow-animation hover:scale-110">
