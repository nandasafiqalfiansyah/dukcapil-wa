            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold">Chat Demo</h1>
                            <p class="text-sm text-whatsapp-100">Try our chatbot - No login required</p>
                        </div>
                    </div>
                    @if (Route::has('login'))
                        <div class="hidden sm:flex items-center space-x-4">
                            @auth
                                <a href="{{ url('/dashboard') }}" class="px-4 py-2 bg-white text-whatsapp-600 rounded-lg hover:bg-whatsapp-50 transition">
                                    Dashboard
                                </a>
                            @else
                                <a href="{{ route('login') }}" class="px-4 py-2 bg-white text-whatsapp-600 rounded-lg hover:bg-whatsapp-50 transition">
                                    Login
                                </a>
                            @endauth
                        </div>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
                <div class="grid grid-cols-1 lg:grid-cols-3">
                    <!-- Info Panel -->
                    <div class="lg:col-span-1 bg-gray-900 text-white p-6">
                    ...
                    <!-- Chat Panel -->
                    <div class="lg:col-span-2 flex flex-col h-[calc(100vh-250px)] min-h-[500px]">
                        <!-- Chat Header -->
                        <div class="bg-gradient-to-r from-whatsapp-500 to-whatsapp-600 text-white p-4 flex items-center">
